...
function Doctor() {
    return (
        <div className="relative flex gap-2 lg:flex-row flex-col bg-transparent mt-10">
            <img src={doctor} className='mx-auto dark:brightness-75 md:w-[450px] lg:h-[450px]' alt="Sample Page" role="img" />
            <div className='p-2'>
                <p className='text-xl lg:text-3xl mb-4 '>Dr. Eddie Harsini is dedicated to the profession of dentistry and is passionate about being one of the best in his field.</p>
                ...
                <div className='p-1 mt-3 lg:mt-12'>
